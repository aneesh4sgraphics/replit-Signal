...
export const primaryApps: NavLink[] = [
  ...
  { path: '/price-list', icon: PriceListIcon, label: 'Price List', description: 'View pricing', iconBg: '#DFAB00', iconColor: '#FFFFFF' },
  ...
  { path: '/product-labels', icon: Tag, label: 'Product Labels', description: 'Barcode labels', iconBg: '#DFAB00', iconColor: '#FFFFFF' },
