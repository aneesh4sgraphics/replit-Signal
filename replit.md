...
- **Price Per Pack Column Addition (2025-07-16)**: Updated Price List app with new column structure. Removed rounding from Price/Sheet column (shows original CSV pricing unchanged). Added "Price Per Pack" column that multiplies price per sheet by minimum order quantity. Applied 99-cent rounding only to Price Per Pack column for retail pricing tier (e.g., $285.00 becomes $285.99 for retail tier only)
